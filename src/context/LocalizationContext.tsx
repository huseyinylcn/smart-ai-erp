...
const uiStrings: Record<Language, Record<string, string>> = {
  az: {
    ...
    'nav.müqavilə_reyestri': 'Müqavilə Reyestri',
    'nav.qiymət_razılaşmaları': 'Qiymət Razılaşmaları',
    'nav.xərclər': 'Xərclər',
    'nav.tətbiqlər': 'Tətbiqlər',
    'nav.saytların_reyestri': 'Saytların Reyestri',
    'nav.onlayn_mağazalar': 'Onlayn Mağazalar',
    'nav.məhsul_kataloqu_(veb)': 'Məhsul Kataloqu (Veb)',
    'nav.veb_sifarişləri': 'Veb Sifarişləri',
    'nav.veb_analitika': 'Veb Analitika',
    'nav.tənzimləmələr': 'Tənzimləmələr',
