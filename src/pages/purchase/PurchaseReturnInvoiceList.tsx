...
const PurchaseReturnInvoiceList = () => {
  ...
  const warehouseReturns = [
    { id: 'W1', number: 'PRW-2024-001', vendor: 'Apple Inc.', date: '2024-04-20', warehouse: 'Bakı Mərkəz', status: 'COMPLETED', invoiceStatus: 'NOT_INVOICED' },
  ];

  const financeReturns = [
    { id: 'F1', number: 'PRINV-2024-001', vendor: 'Apple Inc.', date: '2024-04-20', total: 1200, status: 'COMPLETED', ref: 'PRW-2024-001', eInvNo: 'E-TAX-RET-77', eInvDate: '2024-04-21' },
  ];
  ...
  return (
    <div className="flex flex-col space-y-6 animate-in fade-in duration-500 pb-12">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div>
          <h1 className="text-2xl font-black text-slate-800 dark:text-white uppercase tracking-tight italic">Alışdan Geri Qaytarmalar</h1>
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1 italic italic italic">Təchizatçıya qaytarma: Anbar, Maliyyə və Vergi uçotu</p>
        </div>
        <div className="flex items-center space-x-3">
            {selectedDocs.length > 0 && activeTab === 'WAREHOUSE' && (
                <button 
                  onClick={() => navigate('/purchase/return/invoice/create', { state: { selectedDocs } })}
            ...
            <button 
              onClick={() => navigate(activeTab === 'WAREHOUSE' ? '/purchase/return/warehouse/create' : '/purchase/return/invoice/create')}
      ...
      <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
        <div className="p-6 border-b border-slate-50 dark:border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-50/30">
          ...
          <div className="flex items-center space-x-2 text-[10px] font-black text-rose-600 bg-rose-50 px-4 py-2 rounded-xl border border-rose-100">
            ...
            V-U: E-Qaimə sinxronlaşdırması aktivdir
          </div>
        </div>
